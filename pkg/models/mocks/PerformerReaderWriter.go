...
// GetImageChecksum provides a mock function with given fields: ctx, performerID
func (_m *PerformerReaderWriter) GetImageChecksum(ctx context.Context, performerID int) (*string, error) {
	ret := _m.Called(ctx, performerID)
