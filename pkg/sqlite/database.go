...
type storeRepository struct {
	...
	UserUIConfig   *UserUIConfigStore
	Studio         *StudioStore
	Tag            *TagStore
	Group          *GroupStore
	ShareLink      *ShareLinkStore
	User           *UserStore
	UserAPIKey     *UserAPIKeyStore
	UserCapability *UserCapabilityStore
...
func NewDatabase() *Database {
	...
	*r = storeRepository{
		...
		UserUIConfig:   NewUserUIConfigStore(),
		ShareLink:      NewShareLinkStore(),
		User:           NewUserStore(),
		UserAPIKey:     NewUserAPIKeyStore(),
		UserCapability: NewUserCapabilityStore(),
		UserGroup:      NewUserGroupStore(),
	}
